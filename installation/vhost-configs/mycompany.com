...
# the example below illustrates running a Ramp sub-application.
...
# APPLICATION_ENV variable, its value will default to 'rampdemo'.
#

<VirtualHost *:80>
      ServerName mycompany.com
      ServerAlias www.rampsubappl.mycompany.com
