...
-- a single administrative user, and a set of authorization rules
-- giving that user administrative privileges to create users and
-- establish additional authorization rules.
--
