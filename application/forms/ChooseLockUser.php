...
class Application_Form_ChooseLockUser extends Zend_Form
{
    const LOCK_TABLE = Application_Model_DbTable_Locks::TABLE_NAME;
    ...
    public function init()
    {
        ...
        $vvSource =
            new Application_Model_DbTable_ValidValuesSource(self::LOCK_TABLE);
